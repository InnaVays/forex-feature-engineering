...
def strategy_outcome(data_sl, win_loss, position):
    ...
    print('FINAL RETURN %:  %.3f ' % data_sl_win_loss.strategy_return[-1]*100)
    print('MAX RETURN %:  %.3f ' % data_sl_win_loss.strategy_return.max()*100 )
    print('MIN RETURN %:  %.3f ' % data_sl_win_loss.strategy_return.min()*100)
